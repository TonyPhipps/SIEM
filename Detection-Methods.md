...
## Day of Week/Month Alarm

- Build a watchlist of one or more fields, including one for each day of week/month
- For each matching event, determine if matching record's matching day of week/month field is FALSE
- Alarm if matching record's day of week/month field is FALSE
