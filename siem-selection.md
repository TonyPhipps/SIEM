...
- Single-sign on capability/integration
- Privacy
...
- Alarming
  ...
  - Ability to highlight alarms in user interface
   - Alarm controls such as temporary suppression/muting/aggregation
- Search/Queries
...
- Threat Feed
  - Includes Threat feeds
  - Supporsts adding new threat feeds
  - Multiple threat feed types are supported
  - Rules may leverage threat feeds
- API
  - Support REST API
  - Ability to query/manage events
  - Ability to query/manage rules
  - Ability to query/manage lookup lists
  - Ability to perform/manage active searches
- Data Backup and Retrieval
  - Documented and supported backup and recovery process
  - Backup and recovery time estimates are provided
