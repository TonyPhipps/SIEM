...
| ------------------- | ------------------ | ----------------- | ------------------------------------------------ | ----------------------- | ---------------- | ----------------------- | ------------------- | ----------------------------- | ----------------- | --------------------- |
| Date Added          | Date Added         | Date Added        | Date Added                                       | Date Added              | Date Added       | Date Added              | Date Added          | Date Added                    | Date Added        | Date Added            |
| Added By            | Added By           | Added By          | Added By                                         | Added By                | Added By         | Added By                | Added By            | Added By                      | Added By          | Added By              |
| Category            | Name               | Source            | Initial Lead (what led to including this system) | Source                  | Source           | Source                  | Priority            | Evidence ID                   | Keyword ID        | Query ID              |
| Notes               | Company/Firm       | Status            | Status                                           | Status                  | Status           | Status                  | ID                  | Evidence Type                 | Keyword(s)        | Platform              |
|                     | Role/Title         | System Name       | System Name                                      | Account ID              | Indicator ID     | Indicator ID            | Work Stream         | Evidence Source               | Notes             | Purpose               |
|                     | Email Address      | Date/Time (UTC)   | IP Address                                       | Account Name            | Indicator Type   | Indicator Type          | Request/Task        | Received By                   |                   | Query                 |
|                     | Phone              | Date/Time (Local) | Domain                                           | SID                     | Indicator        | Indicator               | Significant Updates | Date Received                 |                   | Notes                 |
|                     | Location/Time Zone | Activity          | System Role(s)                                   | Domain                  | Full Path        | Details/Comments        | Assigned To         | Received From                 |                   |                       |
|                     |                    | Details/Comments  | Operating System                                 | Account Role            |                  | Earliest Evidence (UTC) | Status              | Data Received                 |                   |                       |
|                     |                    | ATT&CK Alignment  | Significant Findings                             | Significant Findings    |                  | Latest Evidence (UTC)   | Date Last Updated   | Evidence Date (or Date Range) |                   |                       |
|                     |                    | Size (bytes)      | Earliest Evidence (UTC)                          | Earliest Evidence (UTC) | SHA256 Hash      | ATT&CK Alignment        | Date Completed      | Evidence Location             |                   |                       |
|                     |                    | Hash              | Latest Evidence (UTC)                            | Latest Evidence (UTC)   | SHA1 Hash        | Notes                   |                     | Notes                         |                   |                       |
|                     |                    | Owner/Account     | Notes                                            | Notes                   | MD5 Hash         |                         |                     |                               |                   |                       |
|                     |                    | Notes             |                                                  |                         | Type / Purpose   |                         |                     |                               |                   |                       |
|                     |                    |                   |                                                  |                         | Size (Bytes)     |                         |                     |                               |                   |                       |
|                     |                    |                   |                                                  |                         | ATT&CK Alignment |                         |                     |                               |                   |                       |
|                     |                    |                   |                                                  |                         | Notes            |                         |                     |                               |                   |                       |
